...
TEZSIGN_RPI_OVERLAY_BOOT_FILES:raspberrypi0-2w-tezsign = " \
    ...
    dwc2.dtbo;overlays/dwc2.dtbo \
"
TEZSIGN_RPI_OVERLAY_BOOT_FILES:append:raspberrypi0-2w-tezsign = "${@' vc4-kms-v3d.dtbo;overlays/vc4-kms-v3d.dtbo' if d.getVar('TEZSIGN_DEV') == '1' else ''}"
...
do_deploy:append() {
    ...
    install -m 0644 ${S}/overlays/vc4-kms-v3d.dtbo ${DEPLOYDIR}/vc4-kms-v3d.dtbo
